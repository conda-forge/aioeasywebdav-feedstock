About aioeasywebdav-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aioeasywebdav-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2666&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aioeasywebdav-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aioeasywebdav` can be installed with `conda`:
...
```
mamba install aioeasywebdav
```

It is possible to list all of the versions of `aioeasywebdav` available on your platform with `conda`:
...
```
mamba search aioeasywebdav --channel conda-forge
```
...
mamba repoquery search aioeasywebdav --channel conda-forge

# List packages depending on `aioeasywebdav`:
mamba repoquery whoneeds aioeasywebdav --channel conda-forge

# List dependencies of `aioeasywebdav`:
mamba repoquery depends aioeasywebdav --channel conda-forge
```
